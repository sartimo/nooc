...
# endif
# ifdef LIBNOOC_AS_DLL
#  define LIBNOOCAPI __declspec(dllexport)
#  define PUB_FUNC LIBNOOCAPI
# endif
# ifdef _MSC_VER
...
/* target selection */
/* #define NOOC_TARGET_I386   *//* i386 code generator */
/* #define NOOC_TARGET_X86_64 *//* x86-64 code generator */
/* #define NOOC_TARGET_ARM    *//* ARMv4 code generator */
/* #define NOOC_TARGET_ARM64  *//* ARMv8 code generator */
/* #define NOOC_TARGET_C67    *//* TMS320C67xx code generator */
/* #define NOOC_TARGET_RISCV64 *//* risc-v code generator */

/* default target is I386 */
#if !defined(NOOC_TARGET_I386) && !defined(NOOC_TARGET_ARM) && \
    !defined(NOOC_TARGET_ARM64) && !defined(NOOC_TARGET_C67) && \
    !defined(NOOC_TARGET_X86_64) && !defined(NOOC_TARGET_RISCV64)
# if defined __x86_64__
#  define NOOC_TARGET_X86_64
# elif defined __arm__
#  define NOOC_TARGET_ARM
#  define NOOC_ARM_EABI
#  define NOOC_ARM_VFP
#  define NOOC_ARM_HARDFLOAT
# elif defined __aarch64__
#  define NOOC_TARGET_ARM64
# elif defined __riscv
#  define NOOC_TARGET_RISCV64
# else
#  define NOOC_TARGET_I386
# endif
# ifdef _WIN32
#  define NOOC_TARGET_PE 1
# endif
# ifdef __APPLE__
#  define NOOC_TARGET_MACHO 1
# endif
#endif

/* only native compiler supports -run */
#if defined _WIN32 == defined NOOC_TARGET_PE \
    && defined __APPLE__ == defined NOOC_TARGET_MACHO
# if defined __i386__ && defined NOOC_TARGET_I386
#  define NOOC_IS_NATIVE
# elif defined __x86_64__ && defined NOOC_TARGET_X86_64
#  define NOOC_IS_NATIVE
# elif defined __arm__ && defined NOOC_TARGET_ARM
#  define NOOC_IS_NATIVE
# elif defined __aarch64__ && defined NOOC_TARGET_ARM64
#  define NOOC_IS_NATIVE
# elif defined __riscv && defined __LP64__ && defined NOOC_TARGET_RISCV64
#  define NOOC_IS_NATIVE
# endif
#endif

#if defined CONFIG_NOOC_BACKTRACE && CONFIG_NOOC_BACKTRACE==0
# undef CONFIG_NOOC_BACKTRACE
#else
# define CONFIG_NOOC_BACKTRACE 1 /* enable builtin stack backtraces */
#endif

#if defined CONFIG_NOOC_BCHECK && CONFIG_NOOC_BCHECK==0
#  undef CONFIG_NOOC_BCHECK
#else
#  define CONFIG_NOOC_BCHECK 1 /* enable bound checking code */
#endif
...
#elif !(defined NOOC_TARGET_PE || defined NOOC_TARGET_MACHO)
...
/* No ten-byte long doubles on window and macos except in
   cross-compilers made by a mingw-GCC */
    ...
    || (defined NOOC_TARGET_MACHO && defined NOOC_TARGET_ARM64) \
    || (defined _WIN32 && !defined __GNUC__)
# define NOOC_USING_DOUBLE_FOR_LDOUBLE 1
#endif

#ifdef CONFIG_NOOC_PIE
# define CONFIG_NOOC_PIC 1
#endif
...
#endif
#if !defined CONFIG_NOOCDIR && !defined _WIN32
...
#ifndef CONFIG_NOOC_CRTPREFIX
# define CONFIG_NOOC_CRTPREFIX USE_TRIPLET(CONFIG_SYSROOT "/usr/" CONFIG_LDDIR)
#endif
...
/* Below: {B} is substituted by CONFIG_NOOCDIR (rsp. -B option) */

/* system include paths */
#ifndef CONFIG_NOOC_SYSINCLUDEPATHS
# if defined NOOC_TARGET_PE || defined _WIN32
#  define CONFIG_NOOC_SYSINCLUDEPATHS "{B}/include"PATHSEP"{B}/include/winapi"
# else
#  define CONFIG_NOOC_SYSINCLUDEPATHS \
        "{B}/include" \
...
#ifndef CONFIG_NOOC_LIBPATHS
# if defined NOOC_TARGET_PE || defined _WIN32
#  define CONFIG_NOOC_LIBPATHS "{B}/lib"
# else
#  define CONFIG_NOOC_LIBPATHS \
        "{B}" \
...
#ifndef CONFIG_NOOC_ELFINTERP
# if TARGETOS_FreeBSD
#  define CONFIG_NOOC_ELFINTERP "/libexec/ld-elf.so.1"
# elif TARGETOS_FreeBSD_kernel
#  if defined(NOOC_TARGET_X86_64)
#   define CONFIG_NOOC_ELFINTERP "/lib/ld-kfreebsd-x86-64.so.1"
#  else
#   define CONFIG_NOOC_ELFINTERP "/lib/ld.so.1"
#  endif
# elif TARGETOS_DragonFly
#  define CONFIG_NOOC_ELFINTERP "/usr/libexec/ld-elf.so.2"
# elif TARGETOS_NetBSD
#  define CONFIG_NOOC_ELFINTERP "/usr/libexec/ld.elf_so"
# elif TARGETOS_OpenBSD
#  define CONFIG_NOOC_ELFINTERP "/usr/libexec/ld.so"
# elif defined __GNU__
#  define CONFIG_NOOC_ELFINTERP "/lib/ld.so"
# elif defined(NOOC_TARGET_PE)
#  define CONFIG_NOOC_ELFINTERP "-"
# elif defined(NOOC_UCLIBC)
#  define CONFIG_NOOC_ELFINTERP "/lib/ld-uClibc.so.0" /* is there a uClibc for x86_64 ? */
# elif defined NOOC_TARGET_ARM64
#  if defined(NOOC_MUSL)
#   define CONFIG_NOOC_ELFINTERP "/lib/ld-musl-aarch64.so.1"
#  else
#   define CONFIG_NOOC_ELFINTERP "/lib/ld-linux-aarch64.so.1"
#  endif
# elif defined(NOOC_TARGET_X86_64)
#  if defined(NOOC_MUSL)
#   define CONFIG_NOOC_ELFINTERP "/lib/ld-musl-x86_64.so.1"
#  else
#   define CONFIG_NOOC_ELFINTERP "/lib64/ld-linux-x86-64.so.2"
#  endif
# elif defined(NOOC_TARGET_RISCV64)
#  define CONFIG_NOOC_ELFINTERP "/lib/ld-linux-riscv64-lp64d.so.1"
# elif !defined(NOOC_ARM_EABI)
#  if defined(NOOC_MUSL)
#   if defined(NOOC_TARGET_I386)
#     define CONFIG_NOOC_ELFINTERP "/lib/ld-musl-i386.so.1"
#    else
#     define CONFIG_NOOC_ELFINTERP "/lib/ld-musl-arm.so.1"
#    endif
#  else
#   define CONFIG_NOOC_ELFINTERP "/lib/ld-linux.so.2"
#  endif
# endif
#endif

/* var elf_interp dans *-gen.c */
#ifdef CONFIG_NOOC_ELFINTERP
# define DEFAULT_ELFINTERP(s) CONFIG_NOOC_ELFINTERP
#else
# define DEFAULT_ELFINTERP(s) default_elfinterp(s)
#endif

/* (target specific) libnooc1.a */
#ifndef NOOC_LIBNOOC1
# define NOOC_LIBNOOC1 "libnooc1.a"
#endif

#ifndef CONFIG_NOOC_CROSSPREFIX
# define CONFIG_NOOC_CROSSPREFIX ""
#endif

/* library to use with CONFIG_USE_LIBGCC instead of libnooc1.a */
#if defined CONFIG_USE_LIBGCC && !defined NOOC_LIBGCC
#define NOOC_LIBGCC USE_TRIPLET(CONFIG_SYSROOT "/" CONFIG_LDDIR) "/libgcc_s.so.1"
#endif
...
#ifndef PUB_FUNC /* functions used by nooc.c but not in libnooc.h */
# define PUB_FUNC
#endif
...
/* support using libnooc from threads */
#ifndef CONFIG_NOOC_SEMLOCK
# define CONFIG_NOOC_SEMLOCK 1
#endif
...
#ifdef NOOC_PROFILE /* profile all functions */
# define static
# define inline
#endif
...
#if PTR_SIZE == 8 && !defined NOOC_TARGET_PE
# define LONG_SIZE 8
#else
# define LONG_SIZE 4
#endif
...
typedef struct BufferedFile {
    ...
    int line_ref;    /* nooc -E: last printed line */
...
struct NOOCState {
    ...
    unsigned char warn_num; /* temp var for nooc_warning_c() */
    ...
    char *nooc_lib_path; /* CONFIG_NOOCDIR or -B option */
    ...
    /* output type, see NOOC_OUTPUT_XXX */
    int output_type;
    /* output format, see NOOC_OUTPUT_FORMAT_xxx */
    int output_format;
...
# endif
    ...
    /* used by nooc_load_ldscript */
    int fd, cc;

    /* for warnings/errors for object files */
    const char *current_filename;

    /* used by main and nooc_parse_args only */
...
/* symbol was created by noocasm.c first */
...
/* public functions currently used by the nooc main function */
...
#else
#define nooc_free(ptr)           nooc_free_debug(ptr)
#define nooc_malloc(size)        nooc_malloc_debug(size, __FILE__, __LINE__)
#define nooc_mallocz(size)       nooc_mallocz_debug(size, __FILE__, __LINE__)
#define nooc_realloc(ptr,size)   nooc_realloc_debug(ptr, size, __FILE__, __LINE__)
#define nooc_strdup(str)         nooc_strdup_debug(str, __FILE__, __LINE__)
...
#undef strdup
#define strdup(s) use_nooc_strdup(s)
PUB_FUNC int _nooc_error_noabort(const char *fmt, ...) PRINTF_LIKE(1,2);
PUB_FUNC NORETURN void _nooc_error(const char *fmt, ...) PRINTF_LIKE(1,2);
PUB_FUNC void _nooc_warning(const char *fmt, ...) PRINTF_LIKE(1,2);
#define nooc_internal_error(msg) nooc_error("internal compiler error\n"\
...
#ifndef ELF_OBJ_ONLY
ST_FUNC int nooc_add_crt(NOOCState *s, const char *filename);
#endif
...
#ifdef CONFIG_NOOC_BCHECK
ST_FUNC void nooc_add_bcheck(NOOCState *s1);
#endif
#ifdef CONFIG_NOOC_BACKTRACE
ST_FUNC void nooc_add_btstub(NOOCState *s1);
#endif
ST_FUNC void nooc_add_pragma_libs(NOOCState *s1);
PUB_FUNC int nooc_add_library_err(NOOCState *s, const char *f);
PUB_FUNC void nooc_print_stats(NOOCState *s, unsigned total_time);
PUB_FUNC int nooc_parse_args(NOOCState *s, int *argc, char ***argv, int optind);
#ifdef _WIN32
...
ST_FUNC void preprocess_start(NOOCState *s1, int filetype);
ST_FUNC void preprocess_end(NOOCState *s1);
ST_FUNC void noocpp_new(NOOCState *s);
ST_FUNC void noocpp_delete(NOOCState *s);
ST_FUNC int nooc_preprocess(NOOCState *s1);
...
ST_FUNC void noocgen_init(NOOCState *s1);
ST_FUNC int noocgen_compile(NOOCState *s1);
ST_FUNC void noocgen_finish(NOOCState *s1);
...
#if defined CONFIG_NOOC_BCHECK || defined NOOC_TARGET_C67
ST_FUNC Sym *get_sym_ref(CType *type, Section *sec, unsigned long offset, unsigned long size);
#endif
#if defined NOOC_TARGET_X86_64 && !defined NOOC_TARGET_PE
...
#define NOOC_OUTPUT_FORMAT_ELF    0 /* default output format: ELF */
#define NOOC_OUTPUT_FORMAT_BINARY 1 /* binary image output */
#define NOOC_OUTPUT_FORMAT_COFF   2 /* COFF */
#define NOOC_OUTPUT_DYN           NOOC_OUTPUT_DLL
...
ST_FUNC void noocelf_new(NOOCState *s);
ST_FUNC void noocelf_delete(NOOCState *s);
ST_FUNC void noocelf_begin_file(NOOCState *s1);
ST_FUNC void noocelf_end_file(NOOCState *s1);
#ifdef CONFIG_NOOC_BCHECK
ST_FUNC void noocelf_bounds_new(NOOCState *s);
#endif
ST_FUNC Section *new_section(NOOCState *s1, const char *name, int sh_type, int sh_flags);
ST_FUNC void section_realloc(Section *sec, unsigned long new_size);
ST_FUNC size_t section_add(Section *sec, addr_t size, int align);
ST_FUNC void *section_ptr_add(Section *sec, addr_t size);
ST_FUNC Section *find_section(NOOCState *s1, const char *name);
ST_FUNC Section *new_symtab(NOOCState *s1, const char *symtab_name, int sh_type, int sh_flags, const char *strtab_name, const char *hash_name, int hash_sh_flags);
...
ST_FUNC void resolve_common_syms(NOOCState *s1);
ST_FUNC void relocate_syms(NOOCState *s1, Section *symtab, int do_resolve);
ST_FUNC void relocate_sections(NOOCState *s1);

ST_FUNC ssize_t full_read(int fd, void *buf, size_t count);
ST_FUNC void *load_data(int fd, unsigned long file_offset, unsigned long size);
ST_FUNC int nooc_object_type(int fd, ElfW(Ehdr) *h);
ST_FUNC int nooc_load_object_file(NOOCState *s1, int fd, unsigned long file_offset);
ST_FUNC int nooc_load_archive(NOOCState *s1, int fd, int alacarte);
ST_FUNC void add_array(NOOCState *s1, const char *sec, int c);

ST_FUNC struct sym_attr *get_sym_attr(NOOCState *s1, int index, int alloc);
ST_FUNC addr_t get_sym_addr(NOOCState *s, const char *name, int err, int forc);
ST_FUNC void list_elf_symbols(NOOCState *s, void *ctx,
    void (*symbol_cb)(void *ctx, const char *name, const void *val));
ST_FUNC int set_global_sym(NOOCState *s1, const char *name, Section *sec, addr_t offs);
...
#ifndef ELF_OBJ_ONLY
ST_FUNC int nooc_load_dll(NOOCState *s1, int fd, const char *filename, int level);
ST_FUNC int nooc_load_ldscript(NOOCState *s1, int fd);
#endif
#ifndef NOOC_TARGET_PE
ST_FUNC void nooc_add_runtime(NOOCState *s1);
#endif

/* ------------ xxx-link.c ------------ */

#if !defined ELF_OBJ_ONLY || defined NOOC_TARGET_MACHO
...
#if !defined NOOC_TARGET_MACHO || defined NOOC_IS_NATIVE
...
ST_FUNC void build_got_entries(NOOCState *s1, int got_sym); /* in noocelf.c */
#define NEED_BUILD_GOT

#endif
#endif

ST_FUNC void relocate(NOOCState *s1, ElfW_Rel *rel, int type, unsigned char *ptr, addr_t addr, addr_t val);
...
/* ------------ i386-gen.c ------------ */
#if defined NOOC_TARGET_I386 || defined NOOC_TARGET_X86_64 || defined NOOC_TARGET_ARM
...
/* ------------ arm-gen.c ------------ */
#ifdef NOOC_TARGET_ARM
#if defined(NOOC_ARM_EABI) && !defined(CONFIG_NOOC_ELFINTERP)
PUB_FUNC const char *default_elfinterp(struct NOOCState *s);
#endif
ST_FUNC void arm_init(struct NOOCState *s);
ST_FUNC void gen_increment_tcov (SValue *sv);
#endif

/* ------------ arm64-gen.c ------------ */
#ifdef NOOC_TARGET_ARM64
ST_FUNC void gen_opl(int op);
...
/* ------------ c67-gen.c ------------ */
#ifdef NOOC_TARGET_C67
#endif

/* ------------ nooccoff.c ------------ */
#ifdef NOOC_TARGET_COFF
ST_FUNC int nooc_output_coff(NOOCState *s1, FILE *f);
ST_FUNC int nooc_load_coff(NOOCState * s1, int fd);
#endif

/* ------------ noocasm.c ------------ */
ST_FUNC void asm_instr(void);
ST_FUNC void asm_global_instr(void);
ST_FUNC int nooc_assemble(NOOCState *s1, int do_preprocess);
#ifdef CONFIG_NOOC_ASM
ST_FUNC int find_constraint(ASMOperand *operands, int nb_operands, const char *name, const char **pp);
ST_FUNC Sym* get_asm_sym(int name, Sym *csym);
ST_FUNC void asm_expr(NOOCState *s1, ExprValue *pe);
ST_FUNC int asm_int_expr(NOOCState *s1);
/* ------------ i386-asm.c ------------ */
...
/* ------------ noocpe.c -------------- */
#ifdef NOOC_TARGET_PE
ST_FUNC int pe_load_file(struct NOOCState *s1, int fd, const char *filename);
ST_FUNC int pe_output_file(NOOCState * s1, const char *filename);
ST_FUNC int pe_putimport(NOOCState *s1, int dllindex, const char *name, addr_t value);
#if defined NOOC_TARGET_I386 || defined NOOC_TARGET_X86_64
...
#endif
PUB_FUNC int nooc_get_dllexports(const char *filename, char **pp);
...
ST_FUNC int macho_output_file(NOOCState * s1, const char *filename);
ST_FUNC int macho_load_dll(NOOCState *s1, int fd, const char *filename, int lev);
ST_FUNC int macho_load_tbd(NOOCState *s1, int fd, const char *filename, int lev);
#ifdef NOOC_IS_NATIVE
ST_FUNC void nooc_add_macos_sdkpath(NOOCState* s);
ST_FUNC const char* macho_tbd_soname(const char* filename);
#endif
#endif
/* ------------ noocrun.c ----------------- */
#ifdef NOOC_IS_NATIVE
#ifdef CONFIG_NOOC_STATIC
...
#endif
ST_FUNC void nooc_run_free(NOOCState *s1);
#endif

/* ------------ nooctools.c ----------------- */
#if 0 /* included in nooc.c */
ST_FUNC int nooc_tool_ar(NOOCState *s, int argc, char **argv);
#ifdef NOOC_TARGET_PE
ST_FUNC int nooc_tool_impdef(NOOCState *s, int argc, char **argv);
#endif
ST_FUNC int nooc_tool_cross(NOOCState *s, char **argv, int option);
ST_FUNC int gen_makedeps(NOOCState *s, const char *target, const char *filename);
#endif

/* ------------ noocdbg.c ------------ */

ST_FUNC void nooc_debug_new(NOOCState *s);

ST_FUNC void nooc_debug_start(NOOCState *s1);
ST_FUNC void nooc_debug_end(NOOCState *s1);
ST_FUNC void nooc_debug_bincl(NOOCState *s1);
ST_FUNC void nooc_debug_eincl(NOOCState *s1);
ST_FUNC void nooc_debug_putfile(NOOCState *s1, const char *filename);

ST_FUNC void nooc_debug_line(NOOCState *s1);
ST_FUNC void nooc_add_debug_info(NOOCState *s1, int param, Sym *s, Sym *e);
ST_FUNC void nooc_debug_funcstart(NOOCState *s1, Sym *sym);
ST_FUNC void nooc_debug_prolog_epilog(NOOCState *s1, int value);
ST_FUNC void nooc_debug_funcend(NOOCState *s1, int size);
ST_FUNC void nooc_debug_extern_sym(NOOCState *s1, Sym *sym, int sh_num, int sym_bind, int sym_type);
ST_FUNC void nooc_debug_typedef(NOOCState *s1, Sym *sym);
ST_FUNC void nooc_debug_stabn(NOOCState *s1, int type, int value);
ST_FUNC void nooc_debug_fix_anon(NOOCState *s1, CType *t);

ST_FUNC void nooc_tcov_start(NOOCState *s1);
ST_FUNC void nooc_tcov_end(NOOCState *s1);
ST_FUNC void nooc_tcov_check_line(NOOCState *s1, int start);
ST_FUNC void nooc_tcov_block_end(NOOCState *s1, int line);
ST_FUNC void nooc_tcov_block_begin(NOOCState *s1);
ST_FUNC void nooc_tcov_reset_ind(NOOCState *s1);
...
#if defined _WIN32
typedef struct { int init; CRITICAL_SECTION cr; } NOOCSem;
#elif defined __APPLE__
#include <dispatch/dispatch.h>
typedef struct { int init; dispatch_semaphore_t sem; } NOOCSem;
#else
#include <semaphore.h>
typedef struct { int init; sem_t sem; } NOOCSem;
#endif
ST_FUNC void wait_sem(NOOCSem *p);
ST_FUNC void post_sem(NOOCSem *p);
#define NOOC_SEM(s) NOOCSem s
...
#define text_section        NOOC_STATE_VAR(text_section)
#define data_section        NOOC_STATE_VAR(data_section)
#define rodata_section      NOOC_STATE_VAR(rodata_section)
#define bss_section         NOOC_STATE_VAR(bss_section)
#define common_section      NOOC_STATE_VAR(common_section)
#define cur_text_section    NOOC_STATE_VAR(cur_text_section)
#define bounds_section      NOOC_STATE_VAR(bounds_section)
#define lbounds_section     NOOC_STATE_VAR(lbounds_section)
#define symtab_section      NOOC_STATE_VAR(symtab_section)
#define gnu_ext             NOOC_STATE_VAR(gnu_ext)
#define nooc_error_noabort   NOOC_SET_STATE(_nooc_error_noabort)
#define nooc_error           NOOC_SET_STATE(_nooc_error)
#define nooc_warning         NOOC_SET_STATE(_nooc_warning)

#define total_idents        NOOC_STATE_VAR(total_idents)
#define total_lines         NOOC_STATE_VAR(total_lines)
#define total_bytes         NOOC_STATE_VAR(total_bytes)
...
#define nooc_warning_c(sw) NOOC_SET_STATE((\
    nooc_state->warn_num = offsetof(NOOCState, sw) \
    - offsetof(NOOCState, warn_none), _nooc_warning))

/********************************************************/
#endif /* _NOOC_H */

#undef NOOC_STATE_VAR
#undef NOOC_SET_STATE

#ifdef USING_GLOBALS
# define NOOC_STATE_VAR(sym) nooc_state->sym
# define NOOC_SET_STATE(fn) fn
# undef USING_GLOBALS
# undef _nooc_error
#else
# define NOOC_STATE_VAR(sym) s1->sym
# define NOOC_SET_STATE(fn) (nooc_enter_state(s1),fn)
