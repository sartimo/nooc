...
#define _fnoocpy _noocpy
#define _fnoocmp _noocmp
...
#define _tclen(_pc) (1)
#define _noocpy(_pc1,_cpc2) ((*(_pc1) = *(_cpc2)))
#define _noocmp(_cpc1,_cpc2) ((*(_cpc1))-(*(_cpc2)))
...
#define _noocpy _mbccpy
#define _noocpy_l _mbccpy_l
#else
  ...
  _CRTIMP void __cdecl _noocpy(char *_DstCh,const char *_SrcCh);
...
#define _noocmp(_cp1,_cp2) _tcsnccmp(_cp1,_cp2,1)
...
#define _tclen(_pc) (1)
#define _noocpy(_pc1,_cpc2) (*(_pc1) = *(_cpc2))
#define _noocmp(_cpc1,_cpc2) (((unsigned char)*(_cpc1))-((unsigned char)*(_cpc2)))
